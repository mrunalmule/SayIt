...
public class Verbs_Activity6 extends AppCompatActivity {
    ...
    {  final ArrayAdapter adapter = new ArrayAdapter<String>(this, R.layout.activity_listview, wordArrayList);
        ...
        for(String word : ("find\tfinds\tfound\tfound\tfinding\t" +
                "grind\tgrinds\tground\tground\tgrinding\t" +
                "wind\twinds\twound\twound\twinding").split("\t")) {
            wordArrayList.add(word);
        }

        TextView t3=(TextView)findViewById(R.id.text1);
        t3.setText("Verbs like \"find\" shift to \"ound\" endings in the past and past participle");
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Toast.makeText(getApplicationContext(),
                ...
                switch(position){
                    case 0:
                    Toast.makeText(Verbs_Activity6.this, "Position:" + position + " ListItem:" + itemValue, Toast.LENGTH_LONG).show();
