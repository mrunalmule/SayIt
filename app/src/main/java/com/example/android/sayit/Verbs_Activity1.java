...
public class Verbs_Activity1 extends AppCompatActivity {
...
t2.setText("Verbs like \"cut\" do not change in the past or past participle");
        ...
        for(String word : ("cut\tcuts\tcut\tcut\tcutting\t" +
                ...
                "knit\tknits\tknit or knitted\tknit or knitted\tknitting\t" +
                "sit\tsits\tsat\tsat\tsitting\t" +
                "spit\tspits\tspat/spit\tspat/spit\tspitting").split("\t")) {
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Toast.makeText(getApplicationContext(),
                ...
                switch(position){
                    case 0:
                    Toast.makeText(Verbs_Activity1.this, "Position:" + position + " ListItem:" + itemValue, Toast.LENGTH_LONG).show();
