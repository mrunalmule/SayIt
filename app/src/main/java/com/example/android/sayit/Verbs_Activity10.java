...
public class Verbs_Activity10 extends AppCompatActivity {
    ...
    {  final ArrayAdapter adapter = new ArrayAdapter<String>(this, R.layout.activity_listview, wordArrayList);
        ...
        for(String word : ("see\tsees\tsaw\tseen\tseeing\t" +
                "sew\tsews\tsewed\tsewn/sewed\tsewing").split("\t")) {
            wordArrayList.add(word);
        }

        TextView t3=(TextView)findViewById(R.id.text1);
        t3.setText("Verbs like \"see\" have sound or spelling changes in the past and past participle");
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Toast.makeText(getApplicationContext(),
                ...
                switch(position){
                    case 0:
                    Toast.makeText(Verbs_Activity10.this, "Position:" + position + " ListItem:" + itemValue, Toast.LENGTH_LONG).show();
