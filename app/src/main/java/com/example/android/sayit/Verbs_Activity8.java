...
public class Verbs_Activity8 extends AppCompatActivity {
    ...
    {  final ArrayAdapter adapter = new ArrayAdapter<String>(this, R.layout.activity_listview, wordArrayList);
        ...
        for(String word : ("light\tlights\tlit/lighted\tlit/lighted\tlighting\t" +
                "lose\tloses\tlost\tlost\tlosing\t" +
                "leave\tleaves\tleft\tleft\tleaving").split("\t")) {
            wordArrayList.add(word);
        }

        TextView t3=(TextView)findViewById(R.id.text1);
        t3.setText("Verbs like \"lose\" change spelling and sound in the past and past participle");
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Toast.makeText(getApplicationContext(),
                ...
                switch(position){
                    case 0:
                    Toast.makeText(Verbs_Activity8.this, "Position:" + position + " ListItem:" + itemValue, Toast.LENGTH_LONG).show();
