...
public class Verbs_Activity7 extends AppCompatActivity {
    ...
    {  final ArrayAdapter adapter = new ArrayAdapter<String>(this, R.layout.activity_listview, wordArrayList);
        ...
        t3.setText("Verbs like \"break\" shift vowel sounds in the past and past participle. They also use the \"en\" ending in the past participle");
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Toast.makeText(getApplicationContext(),
                ...
                switch(position){
                    case 0:
                        Toast.makeText(Verbs_Activity7.this, "Position:" + position + " ListItem:" + itemValue, Toast.LENGTH_LONG).show();
