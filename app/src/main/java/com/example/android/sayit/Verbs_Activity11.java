...
public class Verbs_Activity11 extends AppCompatActivity {
    ...
    {  final ArrayAdapter adapter = new ArrayAdapter<String>(this, R.layout.activity_listview, wordArrayList);
        ...
        for(String word : ("shoot\tshoots\tshot\tshot\tshooting\t" +
                "wind\twins\twon\twon\twinning").split("\t")) {
            wordArrayList.add(word);
        }

        TextView t3=(TextView)findViewById(R.id.text1);
        t3.setText("Verbs like \"win\" change spelling and sound in the past and past participle");
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Toast.makeText(getApplicationContext(),
                ...
                switch(position){
                    case 0:
                    Toast.makeText(Verbs_Activity11.this, "Position:" + position + " ListItem:" + itemValue, Toast.LENGTH_LONG).show();
