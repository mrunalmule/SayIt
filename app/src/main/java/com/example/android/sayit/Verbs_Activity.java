...
ed.apply();
        ...
        for(String word : ("call calls called called calling clean cleans cleaned cleaned cleaning" +
                " look looks looked looked looking talk talks talked talked talking end ends ended ended ending wait waits waited waited waiting\n" +
                " kiss kisses kissed kissed kissing wash washes washed washed washing live lives lived lived living love loves loved loved loving\n" +
                " beg begs begged begged begging sin sins sinned sinned sinning play plays played played playing" +
                " stay stays stayed stayed staying cry cries cried cried crying study studies studied studied studying die dies died died dying tie ties tied tied tying").split(" ")) {
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Toast.makeText(getApplicationContext(),
                ...
                switch(position){
                    case 0:
                    Toast.makeText(Verbs_Activity.this, "Position:" + position + " ListItem:" + itemValue, Toast.LENGTH_LONG).show();
