...
public class Verbs_Activity5 extends AppCompatActivity {
    ...
    {  final ArrayAdapter adapter = new ArrayAdapter<String>(this, R.layout.activity_listview, wordArrayList);
        ...
        for(String word : ("hold\tholds\theld\theld\tholding\t" +
                "sell\tsells\tsold\tsold\tselling\t" +
                "tell\ttells\ttold\ttold\ttelling").split("\t")) {
            wordArrayList.add(word);
        }

        TextView t3=(TextView)findViewById(R.id.text1);
        t3.setText("Verbs like \"sell\" shift to \"old\" endings in the past and past participle");
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Toast.makeText(getApplicationContext(),
                ...
                switch(position){
                    case 0:
                    Toast.makeText(Verbs_Activity5.this, "Position:" + position + " ListItem:" + itemValue, Toast.LENGTH_LONG).show();
