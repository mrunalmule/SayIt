...
public class Verbs_Activity12 extends AppCompatActivity {
    ...
    {  final ArrayAdapter adapter = new ArrayAdapter<String>(this, R.layout.activity_listview, wordArrayList);
        ...
        for(String word : ("be\tis\tare or am\twas or were\tbeen/being").split("\t")) {
            wordArrayList.add(word);
        }

        TextView t3=(TextView)findViewById(R.id.text1);
        t3.setText("The verb \"be\" has its own unique usage");
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Toast.makeText(getApplicationContext(),
                ...
                switch(position){
                    case 0:
                    Toast.makeText(Verbs_Activity12.this, "Position:" + position + " ListItem:" + itemValue, Toast.LENGTH_LONG).show();
